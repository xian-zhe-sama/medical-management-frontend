...
import {logout,post,get} from "@/net/index.js";
...
function goToDoctorManagePage(){
  router.push('/index/doctor')
}
function goToNurseManagePage(){
  router.push('/index/nurse')
}
function goToAccountManagePage(){
  router.push('/index/account')
}
function goToDepartmentManagePage(){
  router.push('/index/department')
}
function goToMedicineManagePage(){
  router.push('/index/medicine')
}
function goToHospitalizationsManagePage(){
  router.push('/index/hospitalizations')
}
        ...
        <el-aside :width="isCollapsed ? '65px':'200px'" style="margin-right: 20px;background-color: #f3d19e" class="el-aside">
          ...
          <el-scrollbar>
            <el-menu :default-active="['1']" background-color="#f3d19e" >
              <!-- 医生信息管理菜单 -->
              <el-menu-item index="1" @click="goToDoctorManagePage">
                <template #title>
              ...
              <!-- 药品管理菜单 -->
              <el-menu-item index="2" @click="goToNurseManagePage">
                <template #title>
              ...
              <el-menu-item index="3" @click="goToAccountManagePage">
                <template #title>
                  ...
                  <transition name="fade">
                    <el-text v-show="!isCollapsed" >账号管理</el-text>
                  </transition>
                </template>
              </el-menu-item>
